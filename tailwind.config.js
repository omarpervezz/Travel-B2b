    ...
    plugin(function ({ addComponents }) {
      addComponents({
        ...
        ".table-container": {
          ...
          "&::-webkit-scrollbar": { width: "8px", borderRadius: "20px" },
          ...
          "&::-webkit-scrollbar-thumb:hover": { backgroundColor: "#D8ECFD" },
        },
        ...
        ".dark .table-container": {
          ...
          "&::-webkit-scrollbar-track": { backgroundColor: "#34495E" },
          "&::-webkit-scrollbar-thumb:hover": { backgroundColor: "#2C3E50" },
        },
